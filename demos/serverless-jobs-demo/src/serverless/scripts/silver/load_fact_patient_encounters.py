...
def main():
    ...
    if load_type == "full":
        ...
        run_ids = get_all_run_ids(spark, catalog_name, "encounters_bronze")
    else:
        # Incremental load
        ...
        run_ids = get_new_run_ids(spark, catalog_name, "encounters_bronze", last_run_id)
    ...
    df = load_fact_patient_encounters_incremental(spark, catalog_name, run_ids)
